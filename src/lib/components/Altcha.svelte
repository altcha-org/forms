...
<div bind:this={el} class="rounded-md" class:shadow-sm={!floating}>
	<altcha-widget
		...
		debug
		name="altcha"
		style="--altcha-max-width:{floating
			? '260px'
			: '100%'};--altcha-color-base:oklch(var(--b1));--altcha-color-border:oklch(var(--bc) / 0.3);--altcha-border-radius:0.375rem"
	/>
</div>
